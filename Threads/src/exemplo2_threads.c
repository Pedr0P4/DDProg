...
void* hello_world(void *tid){
	if((int)(size_t)tid > 0){
		...
		printf("Esta é a Thread %d. A Thread %d terminou. ", (int)(size_t)tid-1, (int)(size_t)tid-1);
	}else printf("Esta é a PRIMEIRA Thread. ");
...
int main(int argc, char *argv[]){
	...
	printf("Processo pai vai finalizar a soma = %d\n", soma);
